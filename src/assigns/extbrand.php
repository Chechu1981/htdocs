            ...
            <div id="prov0" class="form-extLine">
              <div class="provHeader">
                ...
                <section>
                  ...
                  <select name="proveedor" id="proveedor">
                    <option value=""></option>
                    <option value="PROV1">Dir Ibérica</option>
                    <option value="PROV2">Proveedor 2 Hyundai</option>
                    <option value="PROV3">Proveedor 3 BMW</option>
                  </select>
                </section>
              </div>
              <div id="formLine0" class="formLine">
                ...
                <section>
                  ...
                  <input type="text" name="precio" id="pvp0">
                  <input type="text" name="dtoCompra" id="dtoCompra0">
                  <input type="text" name="dtoVenta" id="dtoVenta0">
