...
$nuevas = $contacts->getExtCountNew($usuario,$puesto,'')[0][0];
$allAdvAssigns = $contacts->getExtCountNew($usuario,$puesto,'all')[0][0];
$enCurso = $contacts->getExtCountNew($usuario, $puesto,'ready')[0][0];
...
<section class="subButtons">
  <button id="new"><?php echo $nuevas; ?> Nuevas Compra</button>
  <?=  $btnAll ?>
