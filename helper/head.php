...
$scripts = (object)[
  ...
  'CESIONESALL' => "/js/cesionesAll.js?1017",
  'CESIONESADV' => "/js/cesionesADV.js?155",
...
<link rel="stylesheet" href="<?php echo $src; ?>/css/style28.css?1255" defer content="1">
<link rel="stylesheet" href="<?php echo $src; ?>/css/150027.css?1004" defer content="1">
<link rel="stylesheet" href="<?php echo $src ."/css/". str_replace(" ","_",strtolower($user)).".css"; ?>" defer content="0">
<script type="text/javascript" src="<?php echo $src; ?>/js/script20.js?1007" defer content='no-cache'></script>
