...
def search_power():
    with sync_playwright() as playwright:
        ...
        browser = playwright.chromium.launch()
        page = browser.new_page()
        page.goto("https://power-supply.kbrw.fr")
        print("Abriendo el Power")
        page.fill('#username',"sd32391")
        page.fill('#password',"Jjma1989")
        page.click('#signOnButton')
        time.sleep(5)
        page.click(".search-collapse-name")
        page.click("text=A appairer")
        page.click("text=Alternative proposée au réparateur")
        page.click("text=Pièce initiale conservée")
        page.click("text=En cours de préparation par Stellantis")
        page.click("text=Livré dans les dernières 48 heures")
        page.click("text=A réceptionner")
